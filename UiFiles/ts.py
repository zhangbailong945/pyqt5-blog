    ...
    def retranslateUi(self, bottomCopyrightWidget):
        ...
        self.label.setText(_translate("ColourfulThread", "LightGray"))
        self.label.setText(_translate("ColourfulThread", "DarkBlack"))
        self.label.setText(_translate("ColourfulThread", "BlueGreen"))
        self.label.setText(_translate("ColourfulThread", "Orange"))
        self.label.setText(_translate("ColourfulThread", "Brown"))
        self.label.setText(_translate("ColourfulThread", "Green"))
        self.label.setText(_translate("ColourfulThread", "Pink"))
        self.label.setText(_translate("ColourfulThread", "Purple"))
        self.label.setText(_translate("ColourfulThread", "Blue"))
        self.label.setText(_translate("ColourfulThread", "GreyBlue"))
        self.label.setText(_translate("ColourfulThread", "Blue"))
        self.label.setText(_translate("ColourfulThread", "Red"))
        self.label.setText(_translate("ThemeWidget", "default"))
